...
class CropsControllerTest < ActionController::TestCase
  ...
  test "should create crop" do
    assert_difference('Crop.count') do
      post :create, crop: { code: @crop.code, description: @crop.description, name: @crop.name, user_id: @crop.user_id }
    end
  ...
  test "should update crop" do
    patch :update, id: @crop, crop: { code: @crop.code, description: @crop.description, name: @crop.name, user_id: @crop.user_id }
    assert_redirected_to crop_path(assigns(:crop))
  end
