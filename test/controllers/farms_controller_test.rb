...
class FarmsControllerTest < ActionController::TestCase
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post :create, farm: { fields: @farm.fields, latitude: @farm.latitude, longitude: @farm.longitude, name: @farm.name }
    end
  ...
  test "should update farm" do
    patch :update, id: @farm, farm: { fields: @farm.fields, latitude: @farm.latitude, longitude: @farm.longitude, name: @farm.name }
    assert_redirected_to farm_path(assigns(:farm))
  end
